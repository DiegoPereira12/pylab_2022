...
def nova_empresa(request):
    if request.method == "GET":
        ...
        if logo.size > 100_000_000:
            messages.add_message(request, constants.ERROR, 'Sua logo não pode te mais de 10 MB')
            return redirect('/home/nova_empresa')
...
def empresas(request):
    ...
    return render(request, 'empresa.html', {'empresas': empresas, 'tecnlogias': tecnologias})
